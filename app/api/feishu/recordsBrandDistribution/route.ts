...
const BITABLE_APP_ID = process.env.FEISHU_RECORDSBrandDistribution_BITABLE_APP_ID;
const TABLE_ID = process.env.FEISHU_RECORDSBrandDistribution_TABLE_ID;
